...
public interface JFTPConstants {
	...
	public static final String SUPPORT_EMAIL = "support@jMethods.com";
	public static final String COMPANY_NAME = "jMethods, Inc.";
	public static final String SALES_EMAIL = "sales@jMethods.com";
}