 ...
 * 
 */
public class ChangeLocalDirectoryDlg extends MDialog implements ActionListener {

	private static final ResourceBundle resources = ResourceLoader
			.getBundle("com.myjavaworld.jftp.ChangeLocalDirectoryDlg");
	...
	/**
	 * Creates an instance of <code>ChangeLocalDirectoryDlg</code>.
	 * 
	 * @param parent
	 *            Parent frame.
	 * 
	 ...
	 * 
	 * @return Directory Name entered by the user.
	 * 
	 */
