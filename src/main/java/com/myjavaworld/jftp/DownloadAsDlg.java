 ...
 * 
 */
public class DownloadAsDlg extends MDialog implements ActionListener {

	private static final ResourceBundle resources = ResourceLoader
			.getBundle("com.myjavaworld.jftp.DownloadAsDlg");
	...
	private void initComponents() {
		...
		String label = formatter.format(new Object[] { remoteFile
				.getNormalizedName() });
